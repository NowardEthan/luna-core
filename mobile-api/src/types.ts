...
export type HealthResponse = {
  ...
  features?: {
    ...
    /** Preferir web_search ao treino pra fatos p�blicos atualiz�veis. */
    pesquisaPreferencialWeb: boolean;
    /** SSE `ready` (gera��o ok) antes de persistir; `done` depois � unlock sem fechar cedo. */
    ...
    /** Buffer de narracao + auto-marca �ltimo ? ap�s nudge (anti-sumi�o). */
